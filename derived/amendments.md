...
|---|---|---|---|
| — | insert | Subsection (a) is amended by inserting after “such goods or services” the following: “, or intentionally traffics or attempts to traffic in labels, patches, stickers, wrappers, badges, emblems, medallions, charms, boxes, containers, cans… | the bill names no machine-readable US Code section |
...
| — | amend | by amending the matter following subparagraph (B) to read as follows: | the bill names no machine-readable US Code section |
