...
|---|---|---|---|
| — | add-at-end | Section 8E of the Inspector General Act (5 U.S.C. App.) is amended by adding at the end the following: | the bill names no machine-readable US Code section |
