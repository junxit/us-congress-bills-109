...
| | |
|---|---|
| Removed | `the grant program` |
| Inserted | `any grant program or emergency response action` |
...
|---|---|---|---|
| `16 U.S.C. § 6403` | replace | Section 204(d) of the Coral Reef Conservation Act of 2000 (16 U.S.C. 6403(d)) is amended by striking paragraph (3) and inserting the following: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
...
| `16 U.S.C. § 6403` | redesignate | by redesignating paragraph (10) as paragraph (12); and | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
