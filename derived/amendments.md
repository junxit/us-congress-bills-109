...
| | |
|---|---|
| Removed | `chapter 46 or chapter 96 of this title` |
| Inserted | `section 521, under chapter 46 or 96,` |
...
| | |
|---|---|
| Removed | `(1) distribute` |
| Inserted | `(A) distributes` |

### 18 U.S.C. § 1952

> by striking “(2) commit” and inserting “(B) commits”;
...
> by striking “(3) otherwise promote, manage, establish, carry on, or facilitate” and inserting “(C) otherwise promotes, manages, establishes, carries on, or facilitates”; and

| | |
|---|---|
| Removed | `(3) otherwise promote, manage, establish, carry on, or facilitate` |
| Inserted | `(C) otherwise promotes, manages, establishes, carries on, or facilitates` |
...
| | |
|---|---|
| Removed | `or imprisoned not more than 25 years, or both` |
...
| | |
|---|---|
| Removed | `specified person, other than his attorney, upon` |
| Inserted | `specified person upon` |
...
> by striking “shall” and inserting “or conspires to commit any of the above acts, shall, for each instance in which the firearm is used, carried, or possessed”;

| | |
|---|---|
| Removed | `shall` |
| Inserted | `or conspires to commit any of the above acts, shall, for each instance in which the firearm is used, carried, or possessed` |

### 18 U.S.C. § 924

> in clause (i), by striking “5 years” and inserting “7 years”; and
...
|---|---|
| Removed | `A juvenile` |
| Inserted | `Except as otherwise provided in this chapter, a juvenile` |
...
| | |
|---|---|
| Removed | `as an adult, except that, with` |
| Inserted | `as an adult. With` |
...
| `18 U.S.C. § 924` | strike | by striking paragraph (4). | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `18 U.S.C. § 924` | strike | Section 924 of title 18, United States Code, is amended by striking subsection (o). | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
...
| `42 U.S.C. § 13862` | replace | in paragraph (4), by striking the period at the end and inserting a semicolon; and | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
