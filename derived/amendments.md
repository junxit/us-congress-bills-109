...
|---|---|---|---|
| `42 U.S.C. § 11137` | insert | Part B of title IV of the Health Care Quality Improvement Act of 1986 (title IV of Public Law 99–660) is amended by inserting after section 421 the following new section: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `42 U.S.C. § 11137` | add-at-end | Section 427(b) of such Act (42 U.S.C. 11137(b)) is amended by adding at the end the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
