...
|---|---|---|---|
| `12 U.S.C. § 4006` | add-at-end | Section 607 of the Expedited Funds Availability Act (12 U.S.C. 4006) (relating to miscellaneous provisions) is amended by adding at the end the following new subsection: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
