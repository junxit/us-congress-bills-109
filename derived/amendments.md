...
| | |
|---|---|
| Removed | `as in effect on` |
| Inserted | `as amended by the Superfund Amendments and Reauthorization Act of 1986 and the Alternative Energy Refueling System Act of 2006` |
...
|---|---|---|---|
| `42 U.S.C. § 6991b` | amend | Section 9003(h) of the Solid Waste Disposal Act (42 U.S.C. 6991b(h)) is amended by adding at the end the following: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
