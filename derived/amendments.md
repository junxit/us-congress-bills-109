...
|---|---|---|---|
| `26 U.S.C. § 1397C` | add-at-end | Section 1397C of the Internal Revenue Code of 1986 (defining enterprise zone business) is amended by adding at the end the following new subsection: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
