...
|---|---|---|---|
| `23 U.S.C. § 127` | add-at-end | Section 127(a) of title 23, United States Code, is amended by adding at the end the following: “The State of West Virginia may allow, by special permit, the operation of vehicles with a gross vehicle weight of up to 126,000 pounds, and w… | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
