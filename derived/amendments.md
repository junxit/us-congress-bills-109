...
|---|---|---|---|
| `26 U.S.C. § 62` | insert | Subsection (a) of section 62 of the Internal Revenue Code of 1986 (defining adjusted gross income) is amended by inserting before the last sentence the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
