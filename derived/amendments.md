...
|---|---|---|---|
| — | strike | in subparagraph (A), by striking “at some time before January 1, 1977”, and | the bill names no machine-readable US Code section |
| — | replace | by striking subparagraph (B) and inserting the following: | the bill names no machine-readable US Code section |
| — | amend | Subparagraph (B) of section 143(l)(3) of the Internal Revenue Code of 1986 (relating to volume limitation) is amended to read as follows: | the bill names no machine-readable US Code section |
