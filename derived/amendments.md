...
|---|---|---|---|
| `8 U.S.C. § 1182` | redesignate | by redesignating the subsection (t) added by section 1(b)(2) of Public Law 108–449 (118 Stat. 3469) as a subsection (u); and | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
