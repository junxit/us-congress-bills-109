...
|---|---|---|---|
| — | strike | by striking “(as defined in section 408(m) without regard to paragraph (3) thereof)” in subparagraph (A), and | the bill names no machine-readable US Code section |
