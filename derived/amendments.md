...
|---|---|---|---|
| — | redesignate | by redesignating paragraph (22) as paragraph (24) and inserting after paragraph (21) the following new paragraphs: | the bill names no machine-readable US Code section |
