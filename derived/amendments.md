...
|---|---|---|---|
| `26 U.S.C. § 24` | add-at-end | Subsection (c) of section 24 of the Internal Revenue Code of 1986 (relating to the child tax credit) is amended by adding at the end the following new paragraphs: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
