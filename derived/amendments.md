...
| `6 U.S.C. § 121` | add-at-end | The table of contents in section 1(b) of such Act is amended by by adding at the end of the items relating to such subtitle the following the following: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
