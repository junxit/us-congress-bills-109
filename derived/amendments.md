...
|---|---|---|---|
| — | amend | For purposes of this section, the term “M3 monetary aggregate” means the inclusive measure of money compiled by adding the following: | the bill names no machine-readable US Code section |
