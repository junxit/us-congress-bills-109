...
# What S. 3883 would do to existing law
...
|---|---|---|---|
| — | strike | by striking “percent” the first place it appears in the table contained in subparagraph (B), | the bill names no machine-readable US Code section |
| — | replace | by striking “99 percent” in such table and inserting “SO2 removal design level”, and | the bill names no machine-readable US Code section |
