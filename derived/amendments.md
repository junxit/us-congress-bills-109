...
|---|---|---|---|
| `10 U.S.C. § 2687` | add-at-end | Effective as of May 13, 2005, the Defense Base Closure and Realignment Act of 1990 (part A of title XXIX of Public Law 101–09510; 10 U.S.C. 2687 note) is amended by adding at the end the following new section: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
