...
|---|---|---|---|
| — | replace | in subsection (a), by striking “The Commission” and inserting “Subject to subsections (c) and (d), the Commission”; | the bill names no machine-readable US Code section |
| — | insert | in subsection (b), by inserting “, subject to subsections (c) and (d),” after “for the issuer shall”; and | the bill names no machine-readable US Code section |
