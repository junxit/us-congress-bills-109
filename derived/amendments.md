...
|---|---|---|---|
| — | replace | Section 1421(d) of the Safe Drinking Water Act (42 U.S.C. 300h(d)) is amended by striking paragraph (1) and inserting the following: | the bill names no machine-readable US Code section |
