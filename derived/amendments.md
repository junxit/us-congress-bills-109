...
# What S. 2656 would do to existing law
...
|---|---|---|---|
| — | add-at-end | Section 3506 of title 44, United States Code (commonly referred to as the “Paperwork Reduction Act”), is amended by adding at the end the following: | the bill names no machine-readable US Code section |
