...
|---|---|---|---|
| `16 U.S.C. § 1532` | insert | by inserting before the period the following: “, and any distinct population segment of the Eastern oyster (Crassostrea virginica) which interbreeds when mature”. | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
