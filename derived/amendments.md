...
|---|---|---|---|
| — | insert | by inserting before “In consultation with” the following: | the bill names no machine-readable US Code section |
| — | replace | by striking “In consultation with” and inserting “(b) Under operating standards promulgated by, and in consultation with,”; and | the bill names no machine-readable US Code section |
| — | redesignate | by striking paragraph (2) (of the matter redesignated as subsection (b) as a result of the amendment under paragraph (2) of this subsection) and inserting the following: | the bill names no machine-readable US Code section |
