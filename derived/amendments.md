...
|---|---|---|---|
| — | add-at-end | Section 4132(a)(1) of the Internal Revenue Code of 1986 (defining taxable vaccine) is amended by adding at the end the following new subparagraph: | the bill names no machine-readable US Code section |
