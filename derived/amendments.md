...
# What H.R. 6284 would do to existing law
...
|---|---|---|---|
| `18 U.S.C. § 2257` | redesignate | Section 165 of the Internal Revenue Code of 1986 (relating to loss deductions) is amended by redesignating subsection (m) as subsection (n) and inserting the following new subsection: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
