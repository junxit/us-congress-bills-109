...
> in paragraph (2), by striking “importance;” and inserting “importance; and”;

| | |
|---|---|
| Removed | `importance;` |
| Inserted | `importance; and` |

### 50 U.S.C. § 1801

> in paragraph (3), by striking “; and” and inserting “.”; and
...
> Section 301(5) of the Foreign Intelligence Surveillance Act of 1978 (50 U.S.C. 1821(5)) is amended by striking “Act, or (B)” and inserting “Act, (B) activities described in section 102(b) of this Act, or (C)”.

| | |
|---|---|
| Removed | `Act, or (B)` |
| Inserted | `Act, (B) activities described in section 102(b) of this Act, or (C)` |

### 50 U.S.C. § 1802

> in clause (i), by striking “transmitted by means of” and all that follows and inserting “of a foreign power, as defined in paragraph (1), (2), or (3) of section 101(a), or an agent of a foreign power, as defined in section 101(b)(1); or”; and

| | |
|---|---|
| Removed | `transmitted by means of` |
| Inserted | `of a foreign power, as defined in paragraph (1), (2), or (3) of section 101(a), or an agent of a foreign power, as defined in section 101(b)(1); or` |

### 50 U.S.C. § 1802

> in clause (ii), by striking “or (3);” and inserting “or (3); and”;
...
> in subparagraph (B), by striking “known;” and inserting “known; and”;
...
> in subparagraph (C), as redesignated by subparagraph (C), by striking “approved; and” and inserting “approved.”;
...
> in paragraph (1), by striking “for the period necessary” and all that follows and insert “for a period not to exceed one year.”; and

| | |
|---|---|
| Removed | `for the period necessary` |
| Inserted | `for a period not to exceed one year.` |

### 50 U.S.C. § 1805

> in paragraph (2), by striking “original order, except that” and all that follows and inserting “original order for a period not to exceed one year.”;
...
| `50 U.S.C. § 1802` | strike | by striking subparagraph (B); and | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `50 U.S.C. § 1802` | redesignate | by redesignating subparagraph (C) as subparagraph (B); | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `50 U.S.C. § 1802` | strike | by striking subsection (a)(4); | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `50 U.S.C. § 1802` | add-at-end | by adding at the end the following new subsection: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `50 U.S.C. § 1804` | strike | by striking paragraphs (6), (9), and (11); | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `50 U.S.C. § 1804` | redesignate | by redesignating paragraphs (7), (8), and (10) as paragraphs (6), (7), and (8), respectively; | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `50 U.S.C. § 1804` | replace | by striking subparagraphs (D) and (E) and inserting the following: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `50 U.S.C. § 1804` | strike | by striking “a statement of the means by which the surveillance will be effected and”; and | the bill quotes the text struck but describes what replaces it |
| `50 U.S.C. § 1804` | amend | by adding “and” at the end; and | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `50 U.S.C. § 1804` | redesignate | in paragraph (8), as redesignated by subparagraph (B), by striking “; and” and inserting a period; | the bill quotes the text struck but describes what replaces it |
| `50 U.S.C. § 1804` | strike | by striking subsection (b); and | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `50 U.S.C. § 1804` | redesignate | by redesignating subsections (c), (d), and (e) as subsections (b), (c), and (d), respectively. | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
...
| `50 U.S.C. § 1805` | redesignate | by redesignating paragraphs (2), (3), (4), and (5) as paragraphs (1), (2), (3), and (4), respectively; | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
| `50 U.S.C. § 1805` | strike | by striking subparagraphs (C), (D), and (F); | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
