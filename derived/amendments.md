...
|---|---|---|---|
| — | insert | The Outer Continental Shelf Lands Act is amended by inserting after section 8 (43 U.S.C. 1337) the following: | the bill names no machine-readable US Code section |
