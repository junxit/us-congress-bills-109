...
| — | redesignate | by redesignating paragraphs (1) and (2) as paragraphs (4) and (3), respectively, and moving the paragraphs so as to appear in numerical order; and | the bill names no machine-readable US Code section |
| — | redesignate | by inserting before paragraph (3) (as redesignated by paragraph (1)) the following: | the bill names no machine-readable US Code section |
| — | replace | by striking subsection (b) and inserting the following: | the bill names no machine-readable US Code section |
| — | replace | in subsection (d)(1), by striking “Beginning on the first day of the 11th fiscal year after the date of enactment of this Act” and inserting “Beginning on October 1, 2005,”; and | the bill names no machine-readable US Code section |
