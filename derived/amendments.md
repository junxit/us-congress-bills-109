...
|---|---|---|---|
| `26 U.S.C. § 168` | insert | The table contained in section 168(g)(3)(B) of such Code is amended by inserting after the item relating to subparagraph (E)(vi) the following: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
