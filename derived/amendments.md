...
|---|---|---|---|
| `42 U.S.C. § 300gg-91(d)(3)` | add-at-end | Section 419A(c) of the Internal Revenue Code of 1986 (relating to account limit) is amended by adding at the end the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
