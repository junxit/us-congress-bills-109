...
| — | amend | The table of sections at the beginning of chapter 5 of such title is amended by adding at the end the following new items | the bill names no machine-readable US Code section |
