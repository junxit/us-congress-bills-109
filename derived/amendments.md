...
|---|---|---|---|
| — | replace | in the subsection heading, by striking “In general” and inserting “Alaska Native veteran allotments”; | the bill names no machine-readable US Code section |
| — | replace | by striking paragraphs (1) through (4) and inserting the following: | the bill names no machine-readable US Code section |
...
| — | insert | in paragraph (3), by inserting before the period at the end the following: “, other than an heir who applies for, and receives, an allotment on behalf of the estate of a deceased individual under paragraph (2).”; | the bill names no machine-readable US Code section |
