...
> in subparagraph (A), by striking “The person” and inserting “Subject to subparagraph (F), the person”; and

| | |
|---|---|
| Removed | `The person` |
| Inserted | `Subject to subparagraph (F), the person` |
...
| `8 U.S.C. § 1324a` | add-at-end | Section 274A(b)(2) of the Immigration and Nationality Act (8 U.S.C. 1324a(b)(2)) is amended by adding at the end the following: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
