...
|---|---|---|---|
| `16 U.S.C. § 1274` | redesignate | by redesignating the last paragraph (relating to the White Salmon River, Washington) as paragraph (167); and | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
