...
| — | insert | by inserting before the semicolon at the end the following: “, where the impairment in each eye is to a visual acuity of 20/200 or less”. | the bill names no machine-readable US Code section |
