...
|---|---|---|---|
| `37 U.S.C. § 406` | replace | The table in section 406(b)(1)(C) of title 37, United States Code, is amended by striking the items relating to pay grades E-7 through E-9 and inserting the following new items: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
