...
|---|---|---|---|
| `50 U.S.C. § 1701` | insert | in the heading of subsection (b), by inserting “of appropriate senior officials of the Sudanese Government” after “assets”; | the bill quotes the text inserted but describes where it goes |
| `50 U.S.C. § 1701` | redesignate | by redesignating subsections (c) through (e) as subsections (d) through (f), respectively; and | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
