...
# What H.R. 5725 would do to existing law
...
|---|---|---|---|
| — | strike | by striking “and” at the end of paragraph (17); | the bill names no machine-readable US Code section |
| — | redesignate | by redesignating paragraph (18) as paragraph (19); | the bill names no machine-readable US Code section |
| — | insert | by inserting after paragraph (17) the following new paragraph: | the bill names no machine-readable US Code section |
| — | replace | in paragraph (19), as so redesignated, by striking “(17)” and inserting “(18)”. | the bill names no machine-readable US Code section |
...
| — | add-at-end | Subsection (i) of such section is further amended by adding at the end the following new paragraphs: | the bill names no machine-readable US Code section |
