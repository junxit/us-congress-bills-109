...
# What H.R. 5831 would do to existing law
...
| — | insert | by inserting after paragraph (2) the following new subparagraph: | the bill names no machine-readable US Code section |
