...
# What H.R. 2211 would do to existing law
...
|---|---|---|---|
| `42 U.S.C. § 9614` | add-at-end | Section 114(c) of the Comprehensive Environmental Response, Compensation, and Liability Act of 1980 (42 U.S.C. 9614(c)) is amended by adding at the end the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
