...
|---|---|---|---|
| `26 U.S.C. § 6511` | add-at-end | Subsection (d) of section 6511 of the Internal Revenue Code of 1986 (relating to special rules applicable to income taxes) is amended by adding at the end the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
