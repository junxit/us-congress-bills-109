...
|---|---|---|---|
| — | add-at-end | Section 310 of title 38, United States Code, is amended by adding at the end the following new subsections: | the bill names no machine-readable US Code section |
