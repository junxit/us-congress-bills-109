...
|---|---|---|---|
| — | replace | The table under section 44(a) of title 28, United States Code, is amended by striking the item relating to the District of Columbia and inserting the following: | the bill names no machine-readable US Code section |
