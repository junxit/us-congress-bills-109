...
| `43 U.S.C. § 390h` | insert | The table of sections in section 2 of Public Law 102–575 is amended by inserting after the item relating to section 163_ the following: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
