...
# What S. 3973 would do to existing law
...
|---|---|---|---|
| — | replace | Section 5307(b)(1) of title 49, United States Code, is amended by striking subparagraph (E) and inserting the following: | the bill names no machine-readable US Code section |
