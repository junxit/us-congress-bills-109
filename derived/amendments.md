...
|---|---|---|---|
| `26 U.S.C. § 7701` | insert | by inserting “(or any plan, program, or arrangement that is in writing, that provides for retirement payments in recognition of prior service to be made to a retired partner, and that is in effect immediately before retirement begins)” a… | the bill quotes the text inserted but describes where it goes |
| `26 U.S.C. § 7701` | insert | by inserting “which may include income described in subparagraphs (A) through (H)” after “(not less frequently than annually”, | the bill quotes the text inserted but describes where it goes |
