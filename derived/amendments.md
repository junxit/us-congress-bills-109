...
|---|---|---|---|
| `26 U.S.C. § 108` | add-at-end | Subsection (b) of section 108 of the Internal Revenue Code of 1986 (relating to reduction of tax attributes) is amended by adding at the end the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
