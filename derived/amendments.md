...
| — | add-at-end | The table of sections in section 1(b) of such Act is amended by adding at the end the following new item: | the bill names no machine-readable US Code section |
| — | strike | Section 647 of the Transportation, Treasury, and Independent Agencies Appropriations Act, 2004 (division F of Public Law 108–199) is amended by striking subsection (e). | the bill names no machine-readable US Code section |
