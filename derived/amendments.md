...
|---|---|---|---|
| `16 U.S.C. § 461` | add-at-end | Section 604(b)(2) of the South Carolina National Heritage Corridor Act of 1996 (title VI of division II of Public Law 104–333; 16 U.S.C. 461 note) is amended by adding at the end the following new subparagraphs: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
