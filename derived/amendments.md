...
|---|---|---|---|
| `26 U.S.C. § 401` | add-at-end | Subparagraph (C) of section 401(a)(9) of the Internal Revenue Code of 1986 (relating to required distributions) is amended by adding at the end the following new clause: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
