...
|---|---|---|---|
| — | add-at-end | Section 139 of the Internal Revenue Code of 1986 (relating to disaster relief payments) is amended by adding at the end the following new subsection: | the bill names no machine-readable US Code section |
