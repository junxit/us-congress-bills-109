...
| `16 U.S.C. § 824d(a)` | insert | Section 205(a) of the Federal Power Act (16 U.S.C. 824d(a)) is amended by inserting after “not just and reasonable” the following: “or that result from a manipulative or deceptive device or contrivance”. | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
