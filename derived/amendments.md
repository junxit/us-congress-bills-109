...
|---|---|---|---|
| `12 U.S.C. § 1715z-20` | strike | in subsection (g), by striking the first sentence; and | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
