...
|---|---|---|---|
| `26 U.S.C. § 121` | add-at-end | Subsection (b) of section 121 of the Internal Revenue Code of 1986 (relating to limitation on exclusion of gain from sale of principal residence) is amended by adding at the end the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
