...
|---|---|---|---|
| `42 U.S.C. § 1396d` | add-at-end | Section 1905(b) of the Social Security Act (42 U.S.C. 1396d(b)) is amended by adding at the end the following: “Notwithstanding the first sentence of this subsection, the Secretary may provide that the Federal medical assistance percenta… | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
