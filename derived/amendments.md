...
|---|---|---|---|
| — | amend | by amending subparagraph (A)(viii) to read as follows: | the bill names no machine-readable US Code section |
| — | amend | by amending subparagraph (B)(viii) to read as follows: | the bill names no machine-readable US Code section |
