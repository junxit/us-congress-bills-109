...
|---|---|---|---|
| `26 U.S.C. § 62` | redesignate | Subsection (a) of section 62 of the Internal Revenue Code of 1986 (defining adjusted gross income) is amended by redesignating paragraph (19) (relating to costs involving discrimination suits, etc.) as paragraph (20) and inserting after … | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
