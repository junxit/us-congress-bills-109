...
|---|---|---|---|
| `19 U.S.C. § 3801` | repeal | Division B of the Trade Act of 2002 (19 U.S.C. 3801 et seq.), and the items relating to that division in the table of contents for that Act, are repealed. | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
