...
|---|---|---|---|
| `26 U.S.C. § 584` | add-at-end | Subsection (h) of section 584 of the Internal Revenue Code of 1986 (relating to nonrecognition treatment for certain transfers to regulated investment companies) is amended by adding at the end the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
