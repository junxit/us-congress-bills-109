...
|---|---|---|---|
| — | add-at-end | Section 263A(f) of the Internal Revenue Code of 1986 (relating to general exceptions) is amended by adding at the end the following new paragraph: | the bill names no machine-readable US Code section |
