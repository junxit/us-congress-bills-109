...
|---|---|---|---|
| `26 U.S.C. § 5061` | add-at-end | Subsection (d) of section 5061 of the Internal Revenue Code of 1986 (relating to time for collecting tax on distilled spirits, wines, and beer) is amended by adding at the end the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
