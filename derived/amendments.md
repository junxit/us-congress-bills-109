...
|---|---|---|---|
| `26 U.S.C. § 170` | redesignate | Section 170 of the Internal Revenue Code of 1986 (relating to charitable, etc., contributions and gifts) is amended by redesignating subsection (o) as subsection (p) and inserting after subsection (n) the following new subsection: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
