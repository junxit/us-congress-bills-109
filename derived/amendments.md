...
|---|---|---|---|
| — | insert | Subpart A of part IV of subchapter A of chapter 1 of the Internal Revenue Code of 1986 (relating to nonrefundable credits) is amended by inserting after section 25B the following new section: | the bill names no machine-readable US Code section |
| — | insert | The table of sections for such subpart A of such Code is amended by inserting after the item relating to section 25B the following new item: | the bill names no machine-readable US Code section |
