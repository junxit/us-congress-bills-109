...
|---|---|
| Removed | `entity, and` |
| Inserted | `entity and has a State law providing for a gaming master plan that has been approved by the Secretary, and` |
...
|---|---|---|---|
| `25 U.S.C. § 2710` | add-at-end | by adding at the end the following new paragraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
