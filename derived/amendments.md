...
|---|---|---|---|
| `26 U.S.C. § 2523` | add-at-end | Paragraph (4) of section 2523(f) of the Internal Revenue Code of 1986 (relating to qualified terminable interest property election) is amended by adding at the end the following new subparagraph: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
