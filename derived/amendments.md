...
|---|---|---|---|
| — | replace | by striking the section heading and all that follows through “(a) The Secretary” and inserting the following: | the bill names no machine-readable US Code section |
