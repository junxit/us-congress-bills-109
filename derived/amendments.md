...
|---|---|---|---|
| `26 U.S.C. § 613A` | amend | Paragraph (4) of section 613A(d) of the Internal Revenue Code of 1986 (relating to limitations on application of subsection (c)) is amended to read as follows: | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
