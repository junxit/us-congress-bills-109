...
> in subparagraph (H), as so redesignated, by striking “subparagraph (H)” and inserting “subparagraph (G)”; and
...
|---|---|---|---|
| `15 U.S.C. § 638` | redesignate | by striking subparagraph (D) and redesignating subparagraphs (E) through (I) as subparagraphs (D) through (H), respectively; and | the instruction refers to the law by structure rather than quoting it, so the words it changes are in the US Code and not in this bill |
