...
|---|---|---|---|
| — | amend | Section 216(e) of the Internal Revenue Code of 1986 (relating to distributions by cooperative housing corporations) is amended to read as follows: | the bill names no machine-readable US Code section |
