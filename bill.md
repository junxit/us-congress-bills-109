...
- **(b)** *Conforming amendments*
  - **(1)** Section 6724(d)(1)(B) of such Code (relating to the definition of information returns) is amended by redesignating clauses (xiii) through (xviii) as clauses (xiv) through (xix), respectively and by inserting after clause (xii) the following new clause:
    > - **(xiii)** section 6050U(a) (relating to returns by cosmetology service providers).
