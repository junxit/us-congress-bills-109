...
## § 1. Central Oklahoma Master Conservatory District feasibility study
...
- **(a)** *Findings* Congress finds that—
  ...
  - **(3)** studies conducted by the Bureau during fiscal year 2003 indicate that the District will require additional water supplies to meet the future needs of the District, including through—
    ...
    - **(B)** the implementation of a seasonal pool plan at Thunderbird Lake;
    - **(C)** the construction of terminal storage to hold wet-weather yield from Thunderbird Lake;
