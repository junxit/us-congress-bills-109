...
## § 2. Conforming the Internal Revenue Code of 1986 to requirements imposed by the women’s health and cancer rights Act of 1998

- **(a)** *In general* Subchapter B of chapter 100 of the Internal Revenue Code of 1986 (relating to other requirements) is amended by inserting after section 9812 the following new section:
  > ## § 9813. Required coverage for reconstructive surgery following mastectomies
  >
  ...
  > - **(c)** *Rule of construction* Nothing in this section shall be construed to prevent a group health plan from negotiating the level and type of reimbursement with a provider for care provided in accordance with this section.

- **(b)** *Clerical amendment* The table of sections for chapter 100 of such Code is amended inserting after the item relating to section 9812 the following new item:
- **(c)** *Effective date*
