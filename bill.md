...
## § 2. Prevention of identity theft; notification of unauthorized access to customer information
...
- **(4)** by inserting after section 521 the following:
  > ## § 522. Prevention of identity theft; notification of unauthorized access to customer information
  >
...
- **(5)** in paragraph (3), as redesignated—
  - **(A)** by striking “institution' means any” and inserting the following:
    > institution'—
    > - **(A)** means any
  ...
  - **(C)** by striking the period at the end and inserting the following:
    ...
    >   - **(iv)** Such other information as the Federal functional regulators determine is appropriate with respect to the financial institutions that are subject to their respective enforcement authority.
...
## § 4. Inclusion of fraud alerts in consumer credit reports
...
## § 5. Studies and reports on improving protection of customer information
