...
## § 1. Disposition of unused benefits in health flexible spending arrangements
...
- **(a)** *In general* Section 125 of the Internal Revenue Code of 1986 (relating to cafeteria plans) is amended by redesignating subsections (h) and (i) as subsections (i) and (j), respectively, and by inserting after subsection (g) the following:
  ...
  >     - **(B)** to the extent permitted by section 106(d), contributed by the employer to a health savings account (as defined in section 223(d)) maintained for the benefit of the employee.
