...
## § 2. Enhanced consumer disclosures regarding minimum payments

Section 127(b) of the Truth in Lending Act (15 U.S.C. 1637(b)) is amended by adding at the end the following:

> - **(11)**
>   - **(A)** Information regarding repayment of the outstanding balance of the consumer under the account, appearing in conspicuous type on the front of the first page of each such billing statement, and accompanied by an appropriate explanation, containing—
...
>   - **(B)**
>     - **(i)** Subject to clause (ii), in making the disclosures under subparagraph (A) the creditor shall apply the interest rate in effect on the date on which the disclosure is made.
...
## § 3. Access to credit counseling and debt management information
