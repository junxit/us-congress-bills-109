...
## § 3. Authorization for electronic surveillance for foreign intelligence purposes
...
- **(3)** in subsection (b), to read as follows:
  > - **(b)**
  >   - **(1)** The Attorney General may require, by written certification, any person with authorized access to electronic communications or equipment used to transmit or store electronic communications to provide information, facilities, or technical assistance—
