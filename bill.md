...
- **(b)** *Additional Copies* With respect to the document described in subsection (a), in addition to the usual number there shall be printed the lesser of—
  - **(1)** 200 copies, of which 60 shall be casebound for the use of Members of the Committee on the Judiciary; or
  - **(2)** the maximum number of copies for which the total production and printing cost does not exceed $7,000, with production and distribution to be allocated in the same proportion as described in paragraph (1).
