...
- **(a)** *Striking of exemptions for authorized distributors of record* Section 503(e) of the Federal Food, Drug, and Cosmetic Act (21 U.S.C. 353(e)) is amended—
  - **(1)** in paragraph (1)—
    ...
    - **(C)** by striking subparagraph (B) and inserting the following:
      ...
      >   - **(ii)** the alternative requirements are technically feasible.
...
- **(c)** *Final rule* The Secretary shall ensure that, not later than 90 days after the date of the enactment of this Act, there is in effect a final rule to implement section 503(e) of the Federal Food, Drug, and Cosmetic Act, including the amendments made by this section.
